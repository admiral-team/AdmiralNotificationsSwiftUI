...
*/
@available(iOS 14.0, *)
public struct ToastActivityIndicator: View {
    ...
    @ObservedObject var schemeProvider: SchemeProvider<ToastActivityIndicatorScheme>
    ...
    public init(
        style: Style = .default,
        size: Size = .medium,
        schemeProvider: SchemeProvider<ToastActivityIndicatorScheme> = AppThemeSchemeProvider<ToastActivityIndicatorScheme>()
    ) {
        self.style = style
        self.size = size
